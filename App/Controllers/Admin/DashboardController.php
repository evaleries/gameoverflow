...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $totalUsers = User::rawFirst('SELECT count(*) as total FROM users')->total;
        ...
        view('admin.dashboard', compact('totalOrders', 'orderProcessing', 'totalUsers', 'recentOrders', 'incomes', 'sales', 'bestProducts'))->output();
    }
}
